...
针对 **2 名 50kg、经常运动女生**，每人每餐目标：850–1000 kcal · 蛋白质 30–40g · 碳水 80–110g。

打开网页 → **⚙ 营养 & AI** → 填入 OpenAI API Key → **AI 完善全部食谱**。Key 仅存本机浏览器。

首次打开会自动**离线估算**份量；也可导出 `recipes.json` 替换仓库文件。
